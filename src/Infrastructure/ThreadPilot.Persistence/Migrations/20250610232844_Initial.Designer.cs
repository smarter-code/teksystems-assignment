...
namespace ThreadPilot.Persistence.Migrations
{
    ...
    [Migration("20250610232844_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.CarInsuranceDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasColumnName("car_insurance_id");

                    b.Property<int>("CarInsuranceTypeId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("car_insurance_type_id");
                    ...
                    b.HasIndex("CarInsuranceTypeId");

                    b.HasIndex("CurrencyId");

                    b.HasIndex("PolicyId")
                        .IsUnique()
                        .HasDatabaseName("idx_car_details_policy");

                    b.HasIndex("VehicleId");

                    b.ToTable("car_insurance_details", (string)null);
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.CarInsuranceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.ToTable("car_insurance_types", (string)null);
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.Person", b =>
                {
                    ...
                    b.Property<string>("PersonalIdentificationNumber")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("TEXT")
                        .HasColumnName("personal_identification_number");
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.HasIndex("RegistrationNumber")
                        .IsUnique()
                        .HasDatabaseName("idx_vehicles_reg_num");
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.CarInsuranceDetail", b =>
                {
                    b.HasOne("ThreadPilot.Domain.Entities.CarInsuranceType", "CarInsuranceType")
                        .WithMany("CarInsuranceDetails")
                        .HasForeignKey("CarInsuranceTypeId")
                    ...
                    b.HasOne("ThreadPilot.Domain.Entities.InsurancePolicy", "Policy")
                        .WithOne("CarInsuranceDetail")
                        .HasForeignKey("ThreadPilot.Domain.Entities.CarInsuranceDetail", "PolicyId")
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.CarInsuranceType", b =>
                {
                    b.Navigation("CarInsuranceDetails");
                });
            ...
            modelBuilder.Entity("ThreadPilot.Domain.Entities.InsurancePolicy", b =>
                {
                    b.Navigation("CarInsuranceDetail")
                        .IsRequired();
